        ...
        tools: [
            {
                ...
                description: "Generate a QR code with custom styling. Returns base64-encoded SVG image data that can be saved or displayed. Supports multiple visual styles.",
                inputSchema: {
                    type: "object",
                    properties: {
                        url: {
